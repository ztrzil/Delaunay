/* CirclePack modifications: triangle.c was moved to triangle.cpp and
ANSI_DECLARATORS was set in the makefile to get the calls to 
'triangulate' to work. In addition,
	TRILIBRARY, NO_TIMER, REDUCED, and CDT_ONLY
were set, as recommended in the Shewchuk's comments.

  I removed some unused variables; I get warnings about comparisions
